...
# installed.
TCL_PREFIX='B:/ds_gg/sample_project/env\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='B:/ds_gg/sample_project/env\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='B:/ds_gg/sample_project/env\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IB:/ds_gg/sample_project/env\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LB:/ds_gg/sample_project/env\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='B:/ds_gg/sample_project/env\Library\lib\tclstub86.lib'
